...
function agg() {
  ...
  b.skills = ['html', 'css', 'javascript', 'angular']
  b.skills.pop()
  a.push(b);
}
agg()
...
function howManyDays() {
  ...
  m = data.getMonth()+ "/";
  a = data.getFullYear()+ "/";
  console.log("Oggi è il " + a + m + g);
  let passato = new Date('2022/2/2')
  if(data>passato) {
    console.log('2022/1/1 è una data passata ')
  }else {
